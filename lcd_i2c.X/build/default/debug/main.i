...
void I2C_Start() {
    ...
    TRISA2 = 0;
    RC3 = 1; _delay((unsigned long)((10)*(4000000UL/4000000.0)));
    RC4 = 1; _delay((unsigned long)((10)*(4000000UL/4000000.0)));
    RC3 = 0; _delay((unsigned long)((10)*(4000000UL/4000000.0)));
    RC4 = 0; _delay((unsigned long)((10)*(4000000UL/4000000.0)));
}
...
uint8_t I2C_Write(uint8_t data) {
    ...
    for(i = 0; i < 8; i++) {
        ...
        RC4 = 1; _delay((unsigned long)((10)*(4000000UL/4000000.0)));
        RC4 = 0; _delay((unsigned long)((5)*(4000000UL/4000000.0)));
        data <<= 1;
    }
...
void LCD_Send(uint8_t value, uint8_t mode) {
    ...
    data = high_nibble | (mode << 0) | (0 << 1) | (1 << 3);
    ...
    data = low_nibble | (mode << 0) | (0 << 1) | (1 << 3);
    I2C_Write(data);
    _delay((unsigned long)((1)*(4000000UL/4000000.0)));
    I2C_Write(data | (1 << 2));
    _delay((unsigned long)((5)*(4000000UL/4000000.0)));

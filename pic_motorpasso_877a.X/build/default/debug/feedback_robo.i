...
void delay_ms_variavel(unsigned int milissegundos) {
    while (milissegundos > 0) {
        _delay((unsigned long)((999)*(4000000/4000000.0)));
        milissegundos--;
    }
}
...
void feedback_led_rgb_definir_cor(rgb_cor_t cor) {
    ...
    switch (cor) {
        case RGB_VERMELHO: (PORTDbits.RD5 = 1); break;
        case RGB_VERDE: (PORTDbits.RD7 = 1); break;
        case RGB_AZUL: (PORTDbits.RD6 = 1); break;
        case RGB_AMARELO: (PORTDbits.RD5 = 1); (PORTDbits.RD7 = 1); break;
        case RGB_MAGENTA: (PORTDbits.RD5 = 1); (PORTDbits.RD6 = 1); break;
        case RGB_CIANO: (PORTDbits.RD7 = 1); (PORTDbits.RD6 = 1); break;
        case RGB_BRANCO: (PORTDbits.RD5 = 1); (PORTDbits.RD7 = 1); (PORTDbits.RD6 = 1); break;
...
void feedback_buzzer_controlar(buzzer_padrao_t padrao, unsigned int duracao_ms_on, unsigned int duracao_ms_off, unsigned char repeticoes) {
    ...
    switch (padrao) {
        case BUZZER_BIPE_CURTO:
            (PORTDbits.RD1 = 1);
            delay_ms_variavel(100);
            (PORTDbits.RD1 = 0);
            break;
        case BUZZER_BIPE_LONGO:
            (PORTDbits.RD1 = 1);
            delay_ms_variavel(500);
            (PORTDbits.RD1 = 0);
            break;
